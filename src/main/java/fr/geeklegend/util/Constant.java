...
public class Constant
{
    ...
    public static final int JOIN_ITEM_TEAMS_SLOT = 1;
    ...
    public static final ItemStack JOIN_ITEM_TEAMS_ITEM = new ItemBuilder(Material.BANNER).setDurability((byte) 15).setName("§eÉquipes §8• §f(Clique droit)").toItemStack();
    ...
    public static final ItemStack GLOBAL_INVENTORY_SUBSTRACT_TEN_ITEM = new ItemBuilder(Material.BANNER).setBaseColor(DyeColor.RED).addBannerPreset(ItemBuilder.BannerPreset.SUBSTRACT, DyeColor.WHITE).hideAllFlags().setName("§c-10").toItemStack();
    public static final ItemStack GLOBAL_INVENTORY_SUBSTRACT_FIVE_ITEM = new ItemBuilder(Material.BANNER).setBaseColor(DyeColor.ORANGE).addBannerPreset(ItemBuilder.BannerPreset.SUBSTRACT, DyeColor.WHITE).hideAllFlags().setName("§6-5").toItemStack();
    public static final ItemStack GLOBAL_INVENTORY_SUBSTRACT_ONE_ITEM = new ItemBuilder(Material.BANNER).setBaseColor(DyeColor.YELLOW).addBannerPreset(ItemBuilder.BannerPreset.SUBSTRACT, DyeColor.WHITE).hideAllFlags().setName("§e-1").toItemStack();
    public static final ItemStack GLOBAL_INVENTORY_ADD_ONE_ITEM = new ItemBuilder(Material.BANNER).setBaseColor(DyeColor.GREEN).addBannerPreset(ItemBuilder.BannerPreset.ADD, DyeColor.WHITE).hideAllFlags().setName("§2+1").toItemStack();
    public static final ItemStack GLOBAL_INVENTORY_ADD_FIVE_ITEM = new ItemBuilder(Material.BANNER).setBaseColor(DyeColor.LIME).addBannerPreset(ItemBuilder.BannerPreset.ADD, DyeColor.WHITE).hideAllFlags().setName("§a+5").toItemStack();
    public static final ItemStack GLOBAL_INVENTORY_ADD_TEN_ITEM = new ItemBuilder(Material.BANNER).setBaseColor(DyeColor.LIGHT_BLUE).addBannerPreset(ItemBuilder.BannerPreset.ADD, DyeColor.WHITE).hideAllFlags().setName("§9+10").toItemStack();

    public static final int SETTINGS_INVENTORY_SIZE = 6 * 9;
    public static final int SETTINGS_PRESETS_INVENTORY_SIZE = 6 * 9;
    public static final int SETTINGS_SERVER_SLOTS_INVENTORY_SIZE = 2 * 9;
    ...
    public static final String SETTINGS_PRESETS_INVENTORY_NAME = "Presets";
    public static final String SETTINGS_SERVER_SLOTS_INVENTORY_NAME = "Gestion des slots";
    ...
    public static final int SETTINGS_INVENTORY_TEAMS_SLOT = 9;
    ...
    public static final int SETTINGS_INVENTORY_WORLD_SLOT = 18;
    ...
    public static final ItemStack SETTINGS_INVENTORY_TEAMS_ITEM = new ItemBuilder(Material.BANNER).setDurability((byte) 15).setName("§eÉquipes").toItemStack();
    ...
    public static final ItemStack SETTINGS_INVENTORY_SERVER_SLOTS_ITEM = new ItemBuilder(Material.SKULL_ITEM).setDurability((byte) 3).setName("§eGestion des slots").toItemStack();

    public static final int SCHEDULER_START_TIMER = 10;

    public static final Material TEAMS_ICON = Material.BANNER;
