...
import fr.geeklegend.uhchost.server.HostRank;
            ...
            if (serverSettings.isHost(player.getName()))
            {
                ...
                } else if (args[0].equalsIgnoreCase("oplist"))
                {
                    ...
                    } else
                    {
                        ...
                        for (Map.Entry<String, HostRank> host : serverSettings.getHosts().entrySet())
                        {
                ...
                } else if (args[0].equalsIgnoreCase("banlist"))
                {
                    ...
                    } else
                    {
                        ...
                        for (String bans : serverSettings.getBans())
                        {
                            player.sendMessage("§7- §f" + bans);
                        }
                    }
                }
            } else
